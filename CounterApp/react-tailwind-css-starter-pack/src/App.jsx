...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#2a3d55] flex-col gap-10">
      ...
      <div className="bg-white flex justify-center gap-12 py-3 rounder-sm text-[25px] text-[#344151]">
        <button onClick={decraseHandler} className="border-r-2 text-center w-20 border-[#bfbfbf] text-5xl">-</button>
